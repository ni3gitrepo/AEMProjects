...
<div class="grid_10 push_1 alpha omega" id="tableBlock">
	<div class="fht-table-wrapper fancyTable"
		style="width: 100%; height: 600px;">

		<div align="center">
			<table>
				<tr>
					<td><input type="text" id="searchKey"  value="" alt="Enter Customer No"/>
					<td><input type="button" id="submit" value="Search" onclick="render('5');"  />
				</tr>
			</table>
		</div>
